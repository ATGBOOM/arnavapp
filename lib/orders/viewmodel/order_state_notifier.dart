...
class OrderStateNotifier  extends StateNotifier<OrdersViewState>{
  ...
  Future<void> fetchCustomerDetails() async{
    ...
    String customerName = await _localeManager.getStringFromKeyValueStorage(LocalStorageKeys.User_Name);
    String customerEmail = await _localeManager.getStringFromKeyValueStorage(LocalStorageKeys.User_Email);
